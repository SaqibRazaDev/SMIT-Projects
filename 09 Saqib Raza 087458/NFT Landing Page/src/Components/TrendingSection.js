            ...
            <div className="row">
                ...
                <div className="col-md-4 my-4">
                    <div className="card card-1">
                        <img src={animal1} className="card-img-top" alt="Large Photo 1" />
                        <div className="card-body">
                            <div className="row">
                                <div className="col-4 px-0">
                                    <img src={animal2} className="img-fluid" alt="Small Photo 1" />
                                </div>
                                <div className="col-4">
                                    <img src={animal3} className="img-fluid" alt="Small Photo 2" />
                                </div>
                                <div className="col-4">
                                    <img src={nfts} className="img-fluid" alt="Small Photo 3" />
                                </div>
                            </div>
                        </div>
                        <div>
                ...
                <div className="col-md-4 my-4">
                    <div className="card card-1">
                        <img src={mashrom1} className="card-img-top" alt="Large Photo 1" />
                        <div className="card-body">
                            <div className="row">
                                <div className="col-4 px-0">
                                    <img src={mashrom2} className="img-fluid" alt="Small Photo 1" />
                                </div>
                                <div className="col-4">
                                    <img src={mashrom2} className="img-fluid" alt="Small Photo 2" />
                                </div>
                                <div className="col-4">
                                    <img src={nfts} className="img-fluid" alt="Small Photo 3" />
                                </div>
                ...
                <div className="col-md-4 my-4">
                    <div className="card card-1">
                        <img src={machine1} className="card-img-top" alt="Large Photo 1" />
                        <div className="card-body">
                            <div className="row">
                                <div className="col-4 px-0">
                                    <img src={machine2} className="img-fluid" alt="Small Photo 1" />
                                </div>
                                <div className="col-4">
                                    <img src={machine3} className="img-fluid" alt="Small Photo 2" />
                                </div>
                                <div className="col-4">
                                    <img src={nfts} className="img-fluid" alt="Small Photo 3" />
                                </div>
